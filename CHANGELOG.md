...
* fix!: negate logic of runtime flags controlling semantic-release ([7544b20](https://github.com/tanjeemh/semantic-release-action-typescript/commit/7544b2089895af14d01326df360e506101bfc183))
* fix!: pass node-version properly to setup-node ([ba0fa52](https://github.com/tanjeemh/semantic-release-action-typescript/commit/ba0fa52a891e09150378166a706de953073933ae))


### Bug Fixes

* add --if-present to all npm script invocations ([2e5ee30](https://github.com/tanjeemh/semantic-release-action-typescript/commit/2e5ee30d31cc12f9e8e0b1a49f1b30eefb62506c))
* always install host node_modules ([ca45c56](https://github.com/tanjeemh/semantic-release-action-typescript/commit/ca45c56cd94148c6376fb49da7d788b7933325a1))
* **ci:** invoke reusable workflow correctly ([b7e7be1](https://github.com/tanjeemh/semantic-release-action-typescript/commit/b7e7be1b3df6e805c3084d60dcb2eb95fb4276a1))
* **ci:** update semantic-release-action/github-actions to v4 ([67ce158](https://github.com/tanjeemh/semantic-release-action-typescript/commit/67ce158ef561194b1a5958dbfbf5c11422286ee5))
* default flag to true ([0d96c29](https://github.com/tanjeemh/semantic-release-action-typescript/commit/0d96c299d662d4153f336aaa25adfe438a480a32))
* **deps:** migrate to semantic-release-action/github-actions ([86c03b6](https://github.com/tanjeemh/semantic-release-action-typescript/commit/86c03b64248eae542967674db021255b4f686f6f))
* **deps:** update dependency semantic-release to v20.1.0 ([5423b5a](https://github.com/tanjeemh/semantic-release-action-typescript/commit/5423b5a33b6b621c0c76b846d33230b46b1ee762))
* **deps:** update dependency semantic-release to v21 ([d97e282](https://github.com/tanjeemh/semantic-release-action-typescript/commit/d97e282157f34cce823224075cfa3e93d0581fb1))
* **deps:** update dependency semantic-release to v21.0.2 ([f43d183](https://github.com/tanjeemh/semantic-release-action-typescript/commit/f43d1836c138da85098b807afd02f3bfc77c8567))
* **deps:** update dependency semantic-release to v21.0.5 ([5b8dc42](https://github.com/tanjeemh/semantic-release-action-typescript/commit/5b8dc42bec7e1dce77b51db31eb2d18b327d4697))
* **deps:** update dependency semantic-release to v21.0.7 ([a97ed9e](https://github.com/tanjeemh/semantic-release-action-typescript/commit/a97ed9e539f7eb3962083df30ed8003209049bd6))
* **deps:** update dependency semantic-release to v21.1.1 ([ca211a3](https://github.com/tanjeemh/semantic-release-action-typescript/commit/ca211a3753e36c805135da4d062ddf12f635e9f6))
* **deps:** update dependency semantic-release to v22 ([b0ad740](https://github.com/tanjeemh/semantic-release-action-typescript/commit/b0ad7404e0fbad3706cad90f17e2efc67562ede2))
* **deps:** update dependency semantic-release to v22.0.12 ([65e8581](https://github.com/tanjeemh/semantic-release-action-typescript/commit/65e85811c785b513d8e5ae14dec374d99cd9f10b))
* **deps:** update dependency semantic-release to v23 ([fb62484](https://github.com/tanjeemh/semantic-release-action-typescript/commit/fb62484fbae31d7704a9515d548025e11fe0aee8))
* **deps:** update dependency semantic-release to v23.0.2 ([9aa5c28](https://github.com/tanjeemh/semantic-release-action-typescript/commit/9aa5c285466a4d38666fd6e27016cb25f4f1954c))
* **deps:** update dependency semantic-release to v23.0.8 ([dd03eba](https://github.com/tanjeemh/semantic-release-action-typescript/commit/dd03ebaca0064138622347ec4a288fd947dc8cea))
* **deps:** update dependency semantic-release to v24 ([7fe00e1](https://github.com/tanjeemh/semantic-release-action-typescript/commit/7fe00e1bf7a78c216f282dbcb678d408751ce8f1))
* **deps:** update dependency semantic-release to v24.1.1 ([e38b91f](https://github.com/tanjeemh/semantic-release-action-typescript/commit/e38b91fa10d1c19b600339bfccd76556de2b109b))
* **deps:** update dependency semantic-release to v24.2.0 ([2198404](https://github.com/tanjeemh/semantic-release-action-typescript/commit/219840429ec03be5f1ba9959638349ed930292be))
* **deps:** update dependency semantic-release to v24.2.3 ([f2b6419](https://github.com/tanjeemh/semantic-release-action-typescript/commit/f2b6419a377ac3ea57d7d2c1fb0f8478d25bd424))
* **deps:** update dependency semantic-release to v24.2.7 ([12c5996](https://github.com/tanjeemh/semantic-release-action-typescript/commit/12c59968b173a91b28970f140c1b58fcdb336fa5))
* **deps:** update dependency semantic-release to v25 ([bd81c9b](https://github.com/tanjeemh/semantic-release-action-typescript/commit/bd81c9bc52afe82c915ab0450ed0f59a1888227e))
* **deps:** update semantic-release monorepo ([e203a3e](https://github.com/tanjeemh/semantic-release-action-typescript/commit/e203a3e23c90e17a0b7a818f8287144ab2ba272c))
* **deps:** upgrade install-github-release-binary to v2 ([34dd4d4](https://github.com/tanjeemh/semantic-release-action-typescript/commit/34dd4d48eb837555cc600a348e2588668594ed75))
* **deps:** upgrade self-reference to latest ([24d0bb1](https://github.com/tanjeemh/semantic-release-action-typescript/commit/24d0bb13a7d93c93ac9b82f973f4ea36c04fc89d))
* install expected Node.js version ([9b89b46](https://github.com/tanjeemh/semantic-release-action-typescript/commit/9b89b4610fd1939ae14cf232494afe7c7ee57f0f))
* only run tests if present ([45fa0e9](https://github.com/tanjeemh/semantic-release-action-typescript/commit/45fa0e9a652c0d5bb6cda64dfda3e510bf3e68e7))
* remove redundant words from step name ([7e220b9](https://github.com/tanjeemh/semantic-release-action-typescript/commit/7e220b9d37c9be5970f2cfc103b3457a66258e29))
* remove unrelated environment variable ([6c12764](https://github.com/tanjeemh/semantic-release-action-typescript/commit/6c12764c70f7058685d3663d6aebbf93435bd0de))
* thread release-node-version through to reusable action properly ([a908a08](https://github.com/tanjeemh/semantic-release-action-typescript/commit/a908a087275c5127da819568fd862f4142192742))
* treat action inputs as string ([13825af](https://github.com/tanjeemh/semantic-release-action-typescript/commit/13825afc6b46638373b4eddb53f04affb2632047))
* update allow-postinstall-scripts code to match documentation ([7bc9008](https://github.com/tanjeemh/semantic-release-action-typescript/commit/7bc9008f70b46c3b8e9feb2da70a44171158d845))
* update node-version to match documentation ([87d72ed](https://github.com/tanjeemh/semantic-release-action-typescript/commit/87d72edbf11b370ab4c5216ec5b66cb62b8a9dd0))
* update project metadata ([5101277](https://github.com/tanjeemh/semantic-release-action-typescript/commit/5101277f7120f1a25b76b5d0f25bc4fa4a779c63)), closes [#4](https://github.com/tanjeemh/semantic-release-action-typescript/issues/4)
* use a single node version for the release workflow ([cac9d3c](https://github.com/tanjeemh/semantic-release-action-typescript/commit/cac9d3c3dcaead4a2995f7f483aa2ecae7300686))
* use consistent job name ([f03d69d](https://github.com/tanjeemh/semantic-release-action-typescript/commit/f03d69d5de8c2c07910f562d4a757826dd992fff))
* use correct input name ([51a3e96](https://github.com/tanjeemh/semantic-release-action-typescript/commit/51a3e9627dc2651e09a7493883dabe90c150b22c))


### Features

* add runtime flag to control semantic-release git ([9b1f384](https://github.com/tanjeemh/semantic-release-action-typescript/commit/9b1f3846cd3879f4424a9c89f85a1c36d76fe7d5)), closes [#3](https://github.com/tanjeemh/semantic-release-action-typescript/issues/3)
* initial commit ([e53d4f7](https://github.com/tanjeemh/semantic-release-action-typescript/commit/e53d4f77ff33fb63586da20def46a3f57275756f))


### Performance Improvements

* use jq to modify semantic-release manifest ([70d11de](https://github.com/tanjeemh/semantic-release-action-typescript/commit/70d11ded7dcab21d9a9d30b53abd691268dfd294))
...
## [3.0.21](https://github.com/semantic-release-action/typescript/compare/v3.0.20...v3.0.21) (2025-10-16)
...
* **deps:** update dependency semantic-release to v24 ([7fe00e1](https://github.com/semantic-release-action/typescript/commit/7fe00e1bf7a78c216f282dbcb678d408751ce8f1))
